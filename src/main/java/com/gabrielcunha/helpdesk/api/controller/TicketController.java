package com.gabrielcunha.helpdesk.api.controller;
...
import com.gabrielcunha.helpdesk.api.dto.Summary;
import com.gabrielcunha.helpdesk.api.entity.ChangeStatus;
import com.gabrielcunha.helpdesk.api.entity.Ticket;
import com.gabrielcunha.helpdesk.api.entity.User;
import com.gabrielcunha.helpdesk.api.enums.ProfileEnum;
import com.gabrielcunha.helpdesk.api.enums.StatusEnum;
import com.gabrielcunha.helpdesk.api.response.Response;
import com.gabrielcunha.helpdesk.api.security.jwt.JwtTokenUtil;
import com.gabrielcunha.helpdesk.api.service.TicketService;
import com.gabrielcunha.helpdesk.api.service.UserService;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> findById(@PathVariable("id") String id){
	    ...
	    for (Iterator<ChangeStatus> interator = changesCurrent.iterator(); interator.hasNext();) {
			ChangeStatus changeStatus = (ChangeStatus) interator.next();
	...
	public ResponseEntity<Response<Page<Ticket>>> findByParams(HttpServletRequest request,
		...
		if(number >0) {
			...
			if(userRequest.getProfile().equals(ProfileEnum.ROLE_TECHNICIAN)) {
				if(assigned) {
					tickets = ticketService.findByParameterAndAssignUser(page, count, title, status, priority, userRequest.getId());
				}else {
